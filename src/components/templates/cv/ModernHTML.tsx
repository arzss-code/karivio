...
export default function ModernHTML({ data }: { data: any }) {
          ...
          {projects.map((proj: any, i: number) => (
            <div key={i} className="cv-item">
              ...
              {typeof proj.description === 'string' && proj.description && (
                <div className="cv-item-subtitle mb-1" style={{ fontSize: '9.5pt' }}>
      ...
      {education && Array.isArray(education) && education.length > 0 && (
        <>
          ...
          {education.map((edu: any, i: number) => (
            <div key={i} className="cv-item" style={{ marginBottom: '8px' }}>
              <div className="cv-item-header flex-wrap">
                <div>
                  <span className="cv-item-title">
                  ...
                  {typeof edu.gpa === 'string' && edu.gpa && (
                    <span style={{ fontSize: '9.5pt', marginLeft: '6px' }}>
