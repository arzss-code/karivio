...
export default function MinimalHTML({ data }: { data: any }) {
    ...
    <div className="cv-document">
      ...
      {header && (
        <div className="cv-header">
          ...
          <div className="cv-contact flex items-center flex-wrap">
            ...
            {(header.phone || header.linkedin) && <span>|</span>}
          ...
          {projects.map((proj: any, i: number) => (
            <div key={i} className="cv-item">
              ...
              {typeof proj.description === 'string' && proj.description && (
                <div className="cv-item-subtitle mb-1" style={{ fontSize: '9pt' }}>
              ...
              <div className="cv-item-header flex-wrap">
                <div>
                  ...
                  {typeof edu.gpa === 'string' && edu.gpa && (
                    <span style={{ fontSize: '9pt', marginLeft: '6px' }}>
      ...
      {certifications && Array.isArray(certifications) && certifications.length > 0 && (
        <>
          ...
          {certifications.map((cert: any, i: number) => {
            ...
            return (
              <div key={i} style={{ marginBottom: 2 }} className="page-break-inside-avoid">
                <span className="cv-item-title">
